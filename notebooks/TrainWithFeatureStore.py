...
dbutils.widgets.text("experiment_name", "/azure-mlops-sample/azure-mlops-sample-experiment-test", label="MLflow experiment name")

# MLflow registered model name to use for the trained mode..
dbutils.widgets.text("model_name", "azure-mlops-sample-model-test", label="Model Name")
