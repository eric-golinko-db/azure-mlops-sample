...
* [Staging workspace registered model](https://adb-staging.net#mlflow/models/staging-azure-mlops-sample-model)
* [Prod workspace registered model](https://adb-prod.net#mlflow/models/prod-azure-mlops-sample-model)
